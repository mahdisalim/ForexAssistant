"""
Django settings for Forex Analysis Assistant
"""
import os
...
ROOT_URLCONF = 'forex_assistant.urls'
...
WSGI_APPLICATION = 'forex_assistant.wsgi.application'
...
ENCRYPTION_KEY = os.getenv('ENCRYPTION_KEY', 'change-this-to-a-random-secure-key')
